...
//     for( attri in i){
//         if (typeof(listConverted.columns[i,attri]) != 'undefined'){
//         var blabla = new courseModel(listConverted.columns[i,attri]);
//         blabla.save(function (err){
//             if (err) return console.log("ca pas marcher!!");
//         })
//     }
// }
// };
